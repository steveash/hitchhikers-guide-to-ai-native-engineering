...
_Generated 2026-04-16 (UTC) by `scripts/generate_dashboard.py`._
...
| `guide/01-daily-workflows.md` | 7/30 | 2026-03-09 (`discussion-hn-agentic-coding-jobs`) | 0% | 564 (n/a) |
| `guide/02-harness-engineering.md` | 12/30 | 2025-09-17 (`failure-claudemd-ignored-compaction`) | 0% | 1172 (n/a) |
| `guide/03-safety-and-verification.md` | 10/30 | 2025-09-17 (`failure-claudemd-ignored-compaction`) | 0% | 660 (n/a) |
| `guide/04-context-engineering.md` | 7/30 | 2025-12-27 (`blog-sankalp-claude-code-20`) | 0% | 873 (n/a) |
| `guide/05-team-adoption.md` | 8/30 | 2025-11-06 (`paper-miller-speed-cost-quality`) | 0% | 1017 (n/a) |
