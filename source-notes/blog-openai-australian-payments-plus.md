...
- **Confidence**: emerging (a specific named before/after figure — 4 hours → 30 minutes — comparable in kind to the self-reported single-company metrics graded emerging in `blog-openai-bbva-banking-transformation.md` Claims 6 and 10; still self-reported with no stated sample size, incident count, or measurement window, and see Claim 3's assessment for the inconsistency with the body-text description of the same use case)
...
- **Confidence**: emerging (specific named figures — 80% creativity/quality, 300+ custom GPTs, 1,000+ Projects — comparable in kind to the self-reported single-company metrics graded emerging in `blog-openai-bbva-banking-transformation.md` Claims 6 and 10; still a self-reported internal survey with no disclosed sample size, survey population, or methodology, and the custom-GPT/Projects counts have no stated time window)
...
- **Confidence**: emerging (a specific named figure — 2+ hours/week for 77% of surveyed employees — comparable in kind to the self-reported single-company metrics graded emerging in `blog-openai-bbva-banking-transformation.md` Claims 6 and 10; the weakest-evidenced of the four headline metrics, with no disclosed survey methodology, sample size, or definition of "saved," and no body-text elaboration anywhere in the article to substantiate how the time savings were realized — see Our assessment)
...
- **Confidence**: emerging (a specific named before/after figure — 1 day, down from days to weeks — comparable in kind to the self-reported single-company metrics graded emerging in `blog-openai-bbva-banking-transformation.md` Claims 6 and 10; still self-reported with no incident count and no disclosed baseline measurement methodology, and the "could previously take days to weeks" baseline reads as a general estimate rather than a measured historical figure)
