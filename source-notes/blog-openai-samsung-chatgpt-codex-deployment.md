...
- **Extends**:
  ...
  - `blog-anthropic-building-enterprise-agents.md` (L'Oréal named as a manufacturing-adjacent, consumer-goods deployment example, Claim 4): extends the corpus's very thin manufacturing-vertical coverage with a second named manufacturer (Samsung Electronics) explicitly targeting AI at "R&D and manufacturing," though — as with L'Oréal — no manufacturing-specific workflow or outcome detail is given by either source.
