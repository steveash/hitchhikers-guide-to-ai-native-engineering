...
- **Novel**:
  ...
  - The `shared/daily-issue-base.md` importable bundle with a typed `import-schema` (Claim 7) is the first corpus documentation of gh-aw's parameterized-shared-import mechanism at this level of mechanical detail — prior notes reference `imports:` generically but none has extracted a bundle's own `import-schema` parameter table and default values.
