...
- **Confidence**: anecdotal (one incident, one document, one author's
  after-the-fact review — the article's own wording is momentarily
  inconsistent, first stating the local file's contents "were found to be
  identical to the source code" before describing the discovered wording
  change in the next paragraph; the substantive finding — a policy-scope
  change was present and initially missed — is clear despite that wording
  inconsistency)
...
- **Contradicts**: Filed as
  [issue #3520](https://github.com/steveash/hitchhikers-guide-to-ai-native-engineering/issues/3520) —
...
4. **One contradiction filed**: see Cross-References → Contradicts above and
   [issue #3520](https://github.com/steveash/hitchhikers-guide-to-ai-native-engineering/issues/3520).
   No verdict is asserted in this note; the issue is left for human/Smith
   resolution per MINER.md §4a.
