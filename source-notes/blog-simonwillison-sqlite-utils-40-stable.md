...
> 4 release blockers and 6 further verified bugs — and has the upgrade guide
> and release notes fully authored by three different models.
...
### Claim 10: Run head-to-head on the identical prompt, GPT-5.5 (Codex Desktop, "xhigh" reasoning) wrote 5 Python scripts and found nothing substantive — only documentation/versioning nits — while Fable 5 (Claude Code) wrote 12 scripts and identified 4 release blockers plus 6 further verified issues (10 total)
